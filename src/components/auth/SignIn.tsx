...
export const SignIn: React.FC<SignInProps> = ({ role, onBack, onSwitchToSignUp }) => {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Improve error messaging for wrong password/email
      if (err instanceof Error) {
        console.log('Error message:', err.message); // Debug log
        // Check for common Supabase auth error messages
            ...
            <div className="mt-6">
              ...
              <div className="mt-6">
                <button
                  ...
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-gray-300 rounded-lg shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                >
