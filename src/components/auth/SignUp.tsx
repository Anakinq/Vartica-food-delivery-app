      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md">
          ...
          <div className="bg-white bg-opacity-10 backdrop-blur-lg rounded-2xl p-5 sm:p-8 border border-white border-opacity-20 shadow-2xl">
            ...
            {/* 🔥 IMPROVED EMAIL HINT */}
            <div className="bg-blue-500 bg-opacity-20 border-l-4 border-blue-400 text-blue-200 px-4 py-4 rounded-lg mb-6">
              <div className="flex">
                <Mail className="h-5 w-5 mt-0.5 mr-2 flex-shrink-0 text-blue-300" />
                <div>
            ...
            <form onSubmit={handleSubmit}>
                      ...
                      {logoPreview ? (
                        <div className="relative inline-block">
                          <img
                            src={logoPreview}
                            alt="Logo preview"
                            className="h-32 w-32 object-cover rounded-lg border-2 border-white border-opacity-30"
                          />
                          <button
                            type="button"
                            onClick={removeLogo}
                            className="absolute -top-2 -right-2 bg-red-500 bg-opacity-80 text-white rounded-full p-1 hover:bg-red-600"
                          >
                            <X className="h-4 w-4" />
                          </button>
                        </div>
                      ) : (
                        <label className="flex flex-col items-center justify-center w-full h-32 border-2 border-white border-opacity-30 border-dashed rounded-lg cursor-pointer bg-white bg-opacity-10 hover:bg-opacity-20">
                          <div className="flex flex-col items-center justify-center pt-5 pb-6">
                            <Upload className="h-8 w-8 text-white text-opacity-60 mb-2" />
                            <p className="text-sm text-white text-opacity-80 font-medium">Upload Logo</p>
                            <p className="text-xs text-white text-opacity-60 mt-1">PNG, JPG up to 2MB</p>
                          </div>
                          <input
                            type="file"
                            className="hidden"
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-orange-500 text-white py-3 rounded-xl font-semibold hover:bg-orange-600 transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed mt-6"
              >
                {isLoading ? (
